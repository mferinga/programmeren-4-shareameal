...
describe('UC206 delete user', () => {
    ...
    it('TC-206-1 Gebruik bestaat niet', (done) => {
        chai
            .request(server)
            .delete("/api/user/6")
            ...
            .end((err, res) => {
                ...
                res.body.should.be.a("string").that.equals("User was not found");
                done();
            })
    })
    it('TC-206-2 Gebruik bestaat niet', (done) => {
        chai
            .request(server)
            .delete("/api/user/1")
    ...
    it('TC-206-3 Gebruik bestaat niet', (done) => {
        chai
            .request(server)
            .delete("/api/user/1")
            .set("authorization", "Bearer " + jwt.sign({ id: 1 }, jwtSecretKey))
            .end((err, res) => {
                res.should.be.an("object");
                let {status, result} = res.body;
                status.should.equals(206);
                res.body.should.be.a("string").that.equals("user with id 1 has been deleted");
                done();
            })
    })
})