...
describe('UC202 show all users', () => {
    ...
    it('TC-202-3 Toon gebruikers op niet bestaande naam', () => {
        chai
            .request(server)
            .get("/api/user/?firstName=qwerty")
            .set("authorization", "Bearer " + jwt.sign({ id: 1 }, jwtSecretKey))
    ...
    it('TC-202-4 Toon gebruikers op isActive false', () => {
        chai
            .request(server)
    ...
    it('TC-202-5 Toon gebruikers op isActive true', () => {
        chai
            .request(server)
    ...
    it('TC-202-6 Toon gebruikers op een bestaande naam', () => {
        chai
            .request(server)
